...
$$\text{temp}_{fordham} = 98.15 - 15.93\text{*veg} - 0.34\text{*albedo} - 2.27$$

When predicting temperatures in Maspeth: 

$$\text{temp}_{maspeth} = 98.15 - 15.93\text{*veg} - 0.34\text{*albedo} - 1.69$$
...
$$\text{temp}_{crownheights} = 98.15 - 15.93\text{*veg} - 0.34\text{*albedo}$$
