...
Scatterplots are a good way to visualize the covariation or relationship between two variables. 
...
Box and whisker plots are good for visualizing the distributions of a variable across different categories. 
