...
A sample of data is simply a collection of observations--a **distribution**. As demonstrated in the previous chapter, histograms are a good way to visualize the **distribution** of data within a variable.  
...
Nonetheless confidence intervals are still useful as they demonstrate the degree of uncertainty in a result, whether the result is accurate or not. There is more theory on confidence intervals in Part II. 
...
A **hypothesis** is essentially a preconceived notion or model for what the population looks like. A hypothesis can be based on anything--the results of a previous experiment or even just a hunch. 
...
Many studies are motivated by the relationships between two or more variables. This section will demonstrate a few tools for visualizing and quantifying dependencies between variables. 
...
Scatterplots are a good way to visualize the relationship between two numeric variables. 
